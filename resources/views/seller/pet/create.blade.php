...
@section('content')
    ...
    <div class="container-fluid pt-4">
        ...
        <div class="alert alert-light alert-dismissible fade show p-3 text-white" role="alert">
            ...
            <div class="col-12 col-md-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('seller.pets.store') }}" method="post" id="pet_form">
                            @csrf
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select class="form-control form-control-sm" name="breed_id" disabled id="breed"
                                    required>
                                    <option value=""></option>
                            ...
                            {{-- <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control form-control-sm" name="vaccine_taken"
                                    placeholder="Eg. 3 in 1,5 in 1" required>
                            </div> --}}

                            <div class="form-group mb-3">
                                <label class="form-label">Price (₱) *</label>
                                <input type="number" min="0" class="form-control form-control-sm" name="price"
                                    placeholder="eg. ₱1500" value="{{ old('price') }}" required>
                            </div>
